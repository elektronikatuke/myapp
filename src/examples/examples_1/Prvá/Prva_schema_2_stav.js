...
function Prva_schema_2_stav() {
    ...
    function bez_prud(){
        document.getElementById("bez_prudu").style.opacity = "0%"
        document.getElementById("hoverdiod_2").style.opacity = "0%"  
        
        setTimeout(() => {
            document.getElementById("bez_prudu").style.opacity = "100%"  
            document.getElementById("hoverdiod_2").style.opacity = "100%"
        }, 3000);
    }
    ...
    <path fill="none"  d="M300 250H14" stroke="black" strokeWidth="2"></path>
    <path fill="none"  d="M300 50H14" stroke="black" strokeWidth="2"></path>
    <path fill="none"  d="M300 50v200" stroke="black" strokeWidth="2"></path>

    <g id="bez_prudu">
    <path fill="none"  d="M514 50v200" stroke="black" strokeWidth="2"></path>
    <path fill="none"  d="M514 250H300" stroke="black" strokeWidth="2"></path>
    <path fill="none"  d="M514 50H300" stroke="black" strokeWidth="2"></path>
    ...
    <path fill="none"  d="M8 100v100" stroke="black" strokeWidth="2"></path>
      <polygon points="8,205 13,195 3,195"/>
          <text x="16" y="150" fill="black" fontSize="24">u</text>{/* V */}
    ...
    <path fill="none"  d="M8 30H48" stroke="black" strokeWidth="2"></path>
      <polygon points="55,30 45,25 45,35"/>
        ...
        <g className="hoverdiod" id="hoverdiod_2" onClick={bez_prud}>
...
export default Prva_schema_2_stav;